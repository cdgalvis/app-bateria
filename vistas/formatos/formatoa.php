<?php 
    ...
    $conexion = new Database;  
    $resultFormatoAIntralaboral = $conexion->DatosFormatoAIntralaboral();

    $conexion = new Database;  
    $resultFormatoAestres = $conexion->DatosFormatoAestres();

    $conexion = new Database;  
    $resultFormatoAExtralaboral = $conexion->DatosFormatoAExtralaboral();
...
<head>
  ...
  <body>
    ...
    <div class="container homepage">
      <div class="row">
        <div class="col-md-12">
          <form action="../../config/formatoA.php" method="POST" role="form" name="formatoA">  
                ...
                <div class="row no-gutters">
                  <div class="col-md-12">
                    ...
                    <div class="list-group d-flex" id="myList" role="tablist">
                        ...
                        <a class="list-group-item list-group-item-action" data-toggle="list" href="#estres" role="tab">EVALUACIÓN DEL ESTRÉS</a>
                  ...
                  <div class="col-md-10">
                    <div class="card-body">
                      ...
                      <div class="tab-content">
                          ...
                          <table class="table">
                            ...
                            <tbody class="text-left">
                              <?php 
                                ...
                                foreach($resultFormatoAIntralaboral as $FormatoAIntralaboral) { 
                              ?>

                                <tr>
                                  <th scope="row"> <?php echo $FormatoAIntralaboral['pre_codigo'] ?></th>
                                  <td> <?php echo $FormatoAIntralaboral['pre_nombre'] ?></td>
                                  <td class="text-center">
                                    <select class="form-control" id="intralaboral<?php echo $FormatoAIntralaboral['pre_codigo'] ?>" name="intralaboral<?php echo $FormatoAIntralaboral['pre_codigo'] ?>">
                        ...
                        <div class="tab-pane" id="estres" role="tabpanel">
                          <header>
                            <h3>EVALUACIÓN DEL ESTRÉS</h3>
                          </header>
                          <br>
                          <table class="table">
                            <thead class="thead-light">
                            ...
                            <tbody class="text-left">
                              <?php 
                                $conteo_estres = 0;
                                foreach($resultFormatoAestres as $FormatoAestres) { 
                              ?>

                                <tr>
                                  <th scope="row"> <?php echo $FormatoAestres['pre_codigo'] ?></th>
                                  <td> <?php echo $FormatoAestres['pre_nombre'] ?></td>
                                  <td class="text-center">
                                    <select class="form-control" id="estres<?php echo $FormatoAestres['pre_codigo'] ?>" name="estres<?php echo $FormatoAestres['pre_codigo'] ?>">
                                      <option value=''>Seleccione una Respuesta</option>
                                      <?php
                                        $conexion = new Database;  
                                        $resultRespuestas = $conexion->DatosRespuestas();
                              ...
                              <input type="hidden" class="form-control" id="conteo_estres" name="conteo_estres" value="<?php echo $conteo_estres ?>">
                          ...
                          <table class="table">
                            ...
                            <tbody class="text-left">
                              <?php 
                                ...
                                foreach($resultFormatoAExtralaboral as $FormatoAExtralaboral) { 
                              ?>
                                <tr>
                                  <th scope="row"> <?php echo $FormatoAExtralaboral['pre_codigo'] ?></th>
                                  <td> <?php echo $FormatoAExtralaboral['pre_nombre'] ?></td>
                                  <td class="text-center">
                                    <select class="form-control" id="extralaboral<?php echo $FormatoAExtralaboral['pre_codigo'] ?>" name="extralaboral<?php echo $FormatoAExtralaboral['pre_codigo'] ?>">
                                      <option value=''>Seleccione una Respuesta</option>
                                      <?php
                                        $conexion = new Database;  
                                        $resultRespuestas = $conexion->DatosRespuestas();
                      ...
                      <br>
                      <div class="col-md-4">
                        <input type="button" class="btn btn-primary"  onclick="EnviarDatosFormatoA()" value='Guardar'>
